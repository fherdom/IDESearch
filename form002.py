...
# Form implementation generated from reading ui file 'form002.ui'
#
# Created: Tue Jul  3 12:25:38 2012
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.tblResult, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblResult, 2, 1, 1, 1)
        self.label = QtGui.QLabel(self.tab001)
        self.label.setObjectName(_fromUtf8("label"))
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1)
        self.btnSearch = QtGui.QPushButton(self.tab001)
        self.btnSearch.setObjectName(_fromUtf8("btnSearch"))
        self.gridLayout.addWidget(self.btnSearch, 0, 2, 1, 1)
        self.chkRemote = QtGui.QCheckBox(self.tab001)
        self.chkRemote.setObjectName(_fromUtf8("chkRemote"))
        self.gridLayout.addWidget(self.chkRemote, 1, 2, 1, 1)
        ...
        self.groupBox_7.setGeometry(QtCore.QRect(15, 30, 541, 161))
        self.groupBox_7.setObjectName(_fromUtf8("groupBox_7"))
        self.layoutWidget = QtGui.QWidget(self.groupBox_7)
        self.layoutWidget.setGeometry(QtCore.QRect(147, 30, 386, 128))
        ...
        self.gridLayout_2.addWidget(self.btnClipboard, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.txtCoordinates, 0, 1, 1, 1)
        self.btnGet = QtGui.QPushButton(self.layoutWidget)
        self.btnGet.setObjectName(_fromUtf8("btnGet"))
        self.gridLayout_2.addWidget(self.btnGet, 2, 1, 1, 1)
        self.btnGo = QtGui.QToolButton(self.layoutWidget)
        self.btnGo.setObjectName(_fromUtf8("btnGo"))
        self.gridLayout_2.addWidget(self.btnGo, 0, 2, 1, 1)
        self.layoutWidget1 = QtGui.QWidget(self.groupBox_7)
        self.layoutWidget1.setGeometry(QtCore.QRect(5, 27, 131, 131))
        self.layoutWidget1.setObjectName(_fromUtf8("layoutWidget1"))
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.layoutWidget1)
        self.verticalLayout_2.setMargin(0)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.radiodms = QtGui.QRadioButton(self.layoutWidget1)
        self.radiodms.setChecked(True)
        self.radiodms.setObjectName(_fromUtf8("radiodms"))
        self.verticalLayout_2.addWidget(self.radiodms)
        self.radiodm = QtGui.QRadioButton(self.layoutWidget1)
        self.radiodm.setObjectName(_fromUtf8("radiodm"))
        self.verticalLayout_2.addWidget(self.radiodm)
        self.radiod = QtGui.QRadioButton(self.layoutWidget1)
        self.radiod.setObjectName(_fromUtf8("radiod"))
        self.verticalLayout_2.addWidget(self.radiod)
        self.radioutm = QtGui.QRadioButton(self.layoutWidget1)
        self.radioutm.setObjectName(_fromUtf8("radioutm"))
        self.verticalLayout_2.addWidget(self.radioutm)
        ...
        Dialog.setTabOrder(self.tabWidget, self.txtSearch)
        Dialog.setTabOrder(self.txtSearch, self.btnSearch)
        Dialog.setTabOrder(self.btnSearch, self.tblResult)
        Dialog.setTabOrder(self.tblResult, self.chkRemote)

    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "Búsquedas de IDECanarias", None, QtGui.QApplication.UnicodeUTF8))
        self.lblResult.setText(QtGui.QApplication.translate("Dialog", "Encontrado (s)", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("Dialog", "¿Lugar?", None, QtGui.QApplication.UnicodeUTF8))
        self.btnSearch.setText(QtGui.QApplication.translate("Dialog", "Buscar", None, QtGui.QApplication.UnicodeUTF8))
        self.chkRemote.setText(QtGui.QApplication.translate("Dialog", "Remoto", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_7.setTitle(QtGui.QApplication.translate("Dialog", "Conversor", None, QtGui.QApplication.UnicodeUTF8))
        self.btnClipboard.setText(QtGui.QApplication.translate("Dialog", "Copiar al portapapeles", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("Dialog", "Coods.: ", None, QtGui.QApplication.UnicodeUTF8))
        self.btnGet.setText(QtGui.QApplication.translate("Dialog", "Empezar captura", None, QtGui.QApplication.UnicodeUTF8))
        self.btnGo.setText(QtGui.QApplication.translate("Dialog", "...", None, QtGui.QApplication.UnicodeUTF8))
